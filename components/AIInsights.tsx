...
const AIInsights = () => {
  ...
  return (
    <div className='bg-white dark:bg-gray-900 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl shadow-cyan-500/10 border border-gray-100 dark:border-cyan-500/20 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-200'>
                  ...
                  {currentAnswer && (
                    <div className='mt-3 p-3 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600'>
                      <div className='flex items-start gap-2'>
                        ...
                        <div className='flex-1'>
                          <h5 className='font-semibold text-gray-900 dark:text-white text-xs mb-1'>
                            AI Answer:
                          </h5>
                          {currentAnswer.isLoading ? (
