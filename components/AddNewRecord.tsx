  ...
  return (
    <div className='bg-white dark:bg-gray-900 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl shadow-cyan-500/10 border border-gray-100 dark:border-cyan-500/20 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300'>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-cyan-50/50 to-blue-50/50 dark:from-cyan-900/10 dark:to-blue-900/10 rounded-xl border border-cyan-100/50 dark:border-cyan-500/30'>
          {/* Expense Description */}
          <div className='space-y-1.5'>
            ...
            <div className='relative'>
              <input
                ...
                className='w-full pl-3 pr-12 sm:pr-14 py-2.5 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-cyan-500/30 focus:bg-white dark:focus:bg-gray-700 focus:border-cyan-400 dark:focus:border-cyan-400 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm shadow-sm hover:shadow-md transition-all duration-200'
